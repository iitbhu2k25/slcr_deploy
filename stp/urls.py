...
from .views import stp_home,GetStatesView,GetDistrictView,GetSubDistrictView,GetVillageView,GetTableView,GetRankView,GetBoundry,GetVillage_UP,GetVaruna
urlpatterns = [
    ...
    path('tempy/',GetVaruna,name='varuna')
